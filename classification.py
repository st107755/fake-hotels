...
def classification_run():
    ...
    X_train,X_test,y_train,y_test = train_test_split(tfidf_vector, label,test_size=0.3,random_state=42)

    ##### Over and undersampling #####
    over = SVMSMOTE(n_jobs=4)
    ...
    return {"fake_stuttgart": fake_percentage_stuttgart, "fake_venice": fake_percentage_venice, "f1": f1}
